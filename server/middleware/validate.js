...
const ALLOWED_STATUSES = ['pending', 'confirmed', 'no_answer', 'rejected', 'packing', 'ready_for_courier', 'sent_to_courier', 'processing', 'in_transit', 'out_for_delivery', 'delivered', 'returned', 'cancelled'];
